...
namespace StudentAdminPortal.API
{
    public class Startup
    {
        ...
        {
            // Add CORS policy here to enable angular UI to talk with API
            services.AddCors(options => 
                options.AddPolicy("angularApplication", builder =>
                {
                    //builder.AllowAnyOrigin(); // To allow any origin
                    builder.WithOrigins("http://localhost:4200") // to allow specific origin
                    .AllowAnyHeader()
            ...
            // Add db context of StudentAdminContext here
            ...
            // Inject the repository here so it can be used in the controller
            ...
            // Add automapper here (Conversion of data model to web model)
